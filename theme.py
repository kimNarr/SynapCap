...
DARK: dict[str, str] = {
    ...
    "provider_gemini_fg": "#8AB4F8",
    "provider_gemini_bg": "#1E2A3D",
    "provider_claude_fg": "#D97757",
...
LIGHT: dict[str, str] = {
    ...
    "provider_gemini_fg": "#2C64C9",
    "provider_gemini_bg": "#E3EDFB",
    "provider_claude_fg": "#A8431C",
