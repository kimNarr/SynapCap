...
- 항상 위에 고정 및 갱신 주기 설정
- 펼침 위젯과 컴팩트 막대의 글꼴 크기·굵기를 각각 설정하고 글꼴에 맞춰 폭·간격·그래프 크기 자동 조절
- Small·Medium·Large 중복 옵션 없이 글꼴과 프로바이더 이름에 맞춰 펼침 폭을 자동 조절
...
4. 톱니바퀴 버튼에서 프로바이더, 표시할 한도, 갱신 주기, 펼침·막대 글꼴과 선택형 사용량 알림, 업데이트 확인 여부를 설정합니다. 펼침 폭은 글꼴과 콘텐츠에 맞춰 자동 조절됩니다.
