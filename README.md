...
- 어두운 바탕에서도 또렷한 브랜드 아이콘과 사용률을 유지하는 고대비 가로형 컴팩트 모드
...
5. 접기 버튼은 위젯을 프로바이더별 사용률이 보이는 가로형 컴팩트 바로 바꾸며, 펼치기 버튼으로 원래 크기로 돌아옵니다. `×` 버튼은 프로그램을 완전히 종료합니다. 트레이 메뉴에서도 표시·숨기기와 종료를 제어할 수 있습니다.
